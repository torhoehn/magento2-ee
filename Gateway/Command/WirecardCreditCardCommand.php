...
/**
 * Class WirecardCreditCardCommand
 * @package Wirecard\ElasticEngine\Gateway
 */
class WirecardCreditCardCommand implements CommandInterface
{
    ...
    {
        $jsResponse = $this->transactionFactory->create($commandSubject);
        $transactionService = $this->transactionServiceFactory->create($this->transactionFactory->getTransactionName());
